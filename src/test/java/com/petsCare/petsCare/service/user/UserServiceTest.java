...
class UserServiceTest {
    ...
    void 회원_가입() {
        //given
        UserJoinForm userJoinForm1 = new UserJoinForm("testMember123", "testMember!23", "Eseir");
        UserJoinForm userJoinForm2 = new UserJoinForm("testMember3342", "testMember!23", "Eseir");

        //when //then
        assertThatThrownBy(() -> userService.joinUser(userJoinForm1));
        assertThatCode(() -> userService.joinUser(userJoinForm2));
    }
}